...
- consider the words *unbelievable* and *renewable*. 
  ...
  - What's the root and are there prefixes or suffixes? 

--

- so they're pretty similar: prefix-root-suffix
...
--
  ...
  1. Does adding an infix make a real word? **believ**-*able* os a real word, but \**un*-**believe** is not
    
    2. What does the word mean? *unbelievable* means *not believable*, not *able to be unbelieved* 
...
--
  ...
  2. What does the word mean? *renewable* means *able to be renewed*, not *newable again*
...
- we can test a word's order of affixation by adding an affix and seeing if it makes a real word

- we can test a word's order of affixation by trying to understand what the word means. if your definition involves some smaller combination of the root and an affix, it suggests that the affix is added first 
...
- without knowing the structure, we wouldn't know how to put together the meanings of a word's different morphemes to create the full set
